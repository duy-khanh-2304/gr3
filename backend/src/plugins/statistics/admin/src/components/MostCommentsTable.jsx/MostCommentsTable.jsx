...
import { CONTENT_TYPES, BASE_URL } from '../../utils/constants';
...
import styles from './mostCommentsTable.module.css'
...
const MostCommentsTable = ({
  ...
  return (
    <CollapseSection
      ...
      defaultOpen
      title="Top posts with the most comments"
            ...
            <Table colCount={COL_COUNT} rowCount={ROW_COUNT}>
              <Thead>
                <Tr>
                  ...
                  <Th>
                    <Typography variant="sigma"># of Comments</Typography>
                  </Th>
                  <Th>
              ...
              <Tbody>
                {data.map((entry, index) => (
                  <Tr key={index}>
                    ...
                    <Td>
                      <Typography textColor="primary600">{entry.comments}</Typography>
                    </Td>
                    <Td>
                      <Flex>
                        <IconButton 
...
export default MostCommentsTable