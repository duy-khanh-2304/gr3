(self.webpackChunklab_nckh=self.webpackChunklab_nckh||[]).push([[2544],{23341:(Y,Z,r)=>{"use strict";r.r(Z),r.d(Z,{CreatePage:()=>Ce,default:()=>Me});var e=r(67294),E=r(6406),o=r(69307),T=r(57713),I=r(79371),b=r(75878),P=r(19442),R=r(26789),x=r(50781),B=r(78549),j=r(9370),F=r(61585),y=r(28469),u=r(20603),N=r(60793),Q=r(41054),z=r(27361),he=r.n(z),A=r(41609),X=r.n(A),me=r(86896),h=r(16550),q=r(1565),w=r(18280),ee=r(48474),ie=r(87751),le=r(87561);const ye=le.Ry().shape({name:le.Z_().required(o.I0.required),description:le.Z_().required(o.I0.required)}),ce=q.ZP.div`
