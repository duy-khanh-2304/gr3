"use strict";
(self["webpackChunklab_nckh"] = self["webpackChunklab_nckh"] || []).push([[5162],{
...
const schema = yup_es/* object */.Ry().shape({
  name: yup_es/* string */.Z_(helper_plugin_esm/* translatedErrors */.I0.string).required(helper_plugin_esm/* translatedErrors */.I0.required).matches(NAME_REGEX, helper_plugin_esm/* translatedErrors */.I0.regex),
  url: yup_es/* string */.Z_(helper_plugin_esm/* translatedErrors */.I0.string).required(helper_plugin_esm/* translatedErrors */.I0.required).matches(URL_REGEX, helper_plugin_esm/* translatedErrors */.I0.regex),
  headers: yup_es/* lazy */.Vo((array) => {
    ...
    return baseSchema.of(
      yup_es/* object */.Ry().shape({
        key: yup_es/* string */.Z_().required(helper_plugin_esm/* translatedErrors */.I0.required),
        value: yup_es/* string */.Z_().required(helper_plugin_esm/* translatedErrors */.I0.required)
      })
    );
  }),
