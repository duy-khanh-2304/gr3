(self.webpackChunklab_nckh=self.webpackChunklab_nckh||[]).push([[2544],{23341:(Y,Z,r)=>{"use strict";r.r(Z),r.d(Z,{CreatePage:()=>Ce,default:()=>Me});var e=r(67294),E=r(66115),o=r(97285),T=r(57713),I=r(79371),b=r(75878),P=r(19442),R=r(26789),x=r(50781),B=r(78549),j=r(9370),F=r(61585),y=r(28469),u=r(20603),N=r(60793),Q=r(41054),z=r(27361),he=r.n(z),A=r(41609),X=r.n(A),me=r(86896),h=r(16550),q=r(1565),w=r(18280),ee=r(48474),ie=r(87751),le=r(87561);const ye=le.Ry().shape({name:le.Z_().required(o.I0.required),description:le.Z_().required(o.I0.required)}),ce=q.ZP.div`
...
`,F=({children:y,disabled:u=!1,error:N,expanded:Q=!1,hasErrorMessage:z=!0,id:he,onToggle:A,toggle:X,size:me="M",variant:h="primary",shadow:q})=>{const w=(0,I.M)(he),ee=E.useMemo(()=>({expanded:Q,onToggle:A,toggle:X,id:w,size:me,variant:h,disabled:u}),[u,Q,w,A,me,X,h]);return(0,e.jsxs)(T.S.Provider,{value:ee,children:[(0,e.jsx)(j,{"data-strapi-expanded":Q,disabled:u,"aria-disabled":u,expanded:Q,hasRadius:!0,variant:h,error:N,shadow:q,children:y}),N&&z&&(0,e.jsx)(R.x,{paddingTop:1,children:(0,e.jsx)(b.Z,{variant:"pi",textColor:"danger600",children:N})})]})}},37362:(Y,Z,r)=>{"use strict";r.d(Z,{v:()=>T});var e=r(85893),E=r(7535),o=r(50781);const T=({children:I,...b})=>{const{expanded:P,id:R}=(0,E.A)();if(!P)return null;const x=`accordion-content-${R}`,B=`accordion-label-${R}`,j=`accordion-desc-${R}`;return(0,e.jsx)(o.x,{role:"region",id:x,"aria-labelledby":B,"aria-describedby":j,...b,children:I})}},7535:(Y,Z,r)=>{"use strict";r.d(Z,{A:()=>o,S:()=>E});var e=r(67294);const E=(0,e.createContext)({disabled:!1,expanded:!1,id:"",size:"M",variant:"primary"}),o=()=>(0,e.useContext)(E)},27375:(Y,Z,r)=>{"use strict";r.d(Z,{B:()=>y});var e=r(85893),E=r(21514),o=r(1565),T=r(63128),I=r(7535);const b=({expanded:u,disabled:N,variant:Q})=>{let z="neutral100";return u?z="primary100":N?z="neutral150":Q==="primary"&&(z="neutral0"),z};var P=r(90139),R=r(80907),x=r(75878),B=r(78549);const j=(0,o.ZP)(P.A)`
  text-align: left;
...
`,x=({children:j})=>(0,e.jsxs)(R,{inline:!0,as:"li",children:[(0,e.jsx)(P.Z,{variant:"pi",textColor:"neutral600",children:j}),(0,e.jsx)(b.x,{"aria-hidden":!0,paddingLeft:3,paddingRight:3,children:(0,e.jsx)(E.Z,{})})]});x.displayName="Crumb";const B=({children:j,label:F,...y})=>(0,e.jsxs)(I.k,{...y,children:[(0,e.jsx)(T.T,{children:F}),(0,e.jsx)("ol",{"aria-hidden":!0,children:j})]});B.displayName="Breadcrumbs"},31439:(Y,Z,r)=>{"use strict";r.d(Z,{Q:()=>T});var e=r(85893),E=r(1565),o=r(55482);const T=({options:b,...P})=>(0,e.jsx)(o.NU,{...P,children:b.map(R=>"children"in R?(0,e.jsx)(o.Ab,{label:R.label,values:R.children.map(x=>x.value.toString()),children:R.children.map(x=>(0,e.jsx)(I,{value:x.value,children:x.label},x.value))},R.label):(0,e.jsx)(o.ML,{value:R.value,children:R.label},R.value))}),I=(0,E.ZP)(o.ML)`
